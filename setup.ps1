...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://raw.githubusercontent.com/rookie-eyes/ise-powershell-profile/main/Microsoft.PowerShellISE_profile.ps1 -OutFile $PROFILE
    ...
    try {
        ...
        Write-Host "Please back up any persistent components of your old profile to [$HOME\Documents\PowerShell\ISEProfile.ps1] as there is an updater in the installed profile which uses the hash to update the profile and will lead to loss of changes"
    }
    catch {
